...
This phase proves the thrill of combination before any hosted service exists.
...
- Privacy is non-negotiable: device-local first, explicit consent, no raw life data shipped without knowledge.
- This is the horizon, not the launch. It earns the trust the soundboard builds.

## Later path: Custom GPT wrapper
