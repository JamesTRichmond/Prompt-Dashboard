...
- Device-local first. Explicit consent. No raw life data shipped without your knowledge.
...
The first public version is static and does **not** send user data anywhere. All persistence stays in the browser through localStorage. The self-model is the horizon, not the launch.
...
See `docs/VISION.md` for the full vision and `docs/roadmap.md` for the staged path.
